...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                        ...
                        <div class="main-menu-three__main-menu-three-box">
                            ...
                            <ul class="main-menu__list one-page-scroll-menu">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        <li><a href="team.html">Tradisi Lisan</a></li>
                                        <li><a href="team-carousel.html">Adat Istiadat</a></li>
                                        <li><a href="team-details.html">Ritus</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        <li><a href="team.html">Manuskrip</a></li>
                                        <li><a href="team-carousel.html">Teknologi Tradisional</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a href="#">Seni Budaya <span class="main-menu-border"></span></a>
                                    <ul>
                                        <li><a href="team.html">Seni</a></li>
                                        <li><a href="team-carousel.html">Budaya</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a href="#">Rekreasi dan Hiburan <span class="main-menu-border"></span></a>
                                    <ul>
                                        <li><a href="team.html">Permainan Rakyat</a></li>
                                        <li><a href="team-carousel.html">Olahraga Tradisional</a></li>
                                    </ul>
                                </li>
                                <li class="scrollToLink"><a href="#contact">Hubungi Kami </a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three" style="background-image: url(assets/images/backgrounds/main-slider-3-1.jpg);"></div>
                        <!-- /.image-layer -->
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-12">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three" style="background-image: url(assets/images/backgrounds/main-slider-3-2.jpg);"></div>
                        <!-- /.image-layer -->
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-12">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer-three" style="background-image: url(assets/images/backgrounds/main-slider-3-3.jpg);"></div>
                        <!-- /.image-layer -->
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-12">
        ...
        <section class="feature-three">
            <div class="feature-three-bg" style="background-image: url(assets/images/backgrounds/feature-three-bg.jpg);"></div>
            <div class="container">
                                ...
                                <ul class="list-unstyled feature-three__top-icon-list">
                                    <li>
                                        <div class="feature-three__top-icon-content">
                                            ...
                                            <h3 class="feature-three__top-title"><a href="about.html">Smart Work</a>
                                            </h3>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="feature-three__top-icon-content">
                                            ...
                                            <h3 class="feature-three__top-title"><a href="about.html">Unique Design</a>
                                            </h3>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="feature-three__top-icon-content">
                                            ...
                                            <h3 class="feature-three__top-title"><a href="team.html">Skilled Team</a>
                                            </h3>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="feature-three__top-icon-content">
                                            ...
                                            <h3 class="feature-three__top-title"><a href="contact.html">Best Pricing</a>
                                            </h3>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="feature-three__top-icon-content">
                                            ...
                                            <h3 class="feature-three__top-title"><a href="about.html">Quality
                                                    Material</a></h3>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="col-xl-12">
                                <div class="feature-three__bottom-inner">
                                    <div class="feature-three__bottom-left">
                                        <p class="feature-three__bottom-text">Our services does not end here. Find out
                                            how we can help your <span>Home & Office.</span></p>
                                    </div>
                                    <a href="room-wallpapers.html" class="feature-three__btn thm-btn">More Services</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="services-one__single wow fadeInUp" data-wow-delay="100ms">
                            <div class="services-one__img">
                                <img src="<?= base_url('assets-public/') ?>assets/images/services/services-1-1.jpg" alt="">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="services-one__single wow fadeInUp" data-wow-delay="200ms">
                            <div class="services-one__img">
                                <img src="<?= base_url('assets-public/') ?>assets/images/services/services-1-2.jpg" alt="">
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="services-one__single wow fadeInUp" data-wow-delay="300ms">
                            <div class="services-one__img">
                                <img src="<?= base_url('assets-public/') ?>assets/images/services/services-1-3.jpg" alt="">
                                <div class="services-one__icon">
        ...
        <section class="quality-work">
            <div class="quality-work-shape-1 float-bob-x">
                <img src="<?= base_url('assets-public/') ?>assets/images/shapes/quality-work-shape-1.png" alt="">
            </div>
            <div class="quality-work-shape-2 float-bob-y">
                <img src="<?= base_url('assets-public/') ?>assets/images/shapes/quality-work-shape-2.png" alt="">
            </div>
            <div class="quality-work-shape-3 float-bob-x">
                <img src="<?= base_url('assets-public/') ?>assets/images/shapes/quality-work-shape-3.png" alt="">
            </div>
            <div class="quality-work-shape-4">
                <img src="<?= base_url('assets-public/') ?>assets/images/shapes/quality-work-shape-4.png" alt="">
            </div>
            <div class="quality-work-shape-5 float-bob-x">
                <img src="<?= base_url('assets-public/') ?>assets/images/shapes/quality-work-shape-5.png" alt="">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="quality-work__left">
                            <div class="quality-work__img-box">
                                <div class="quality-work__img">
                                    <img src="<?= base_url('assets-public/') ?>assets/images/resources/quality-work-img-1.png" alt="">
                                </div>
                                <div class="quality-work__small-img">
                                    <img src="<?= base_url('assets-public/') ?>assets/images/resources/quality-work-small-img.jpg" alt="">
                                </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="project-one__left">
                                                <div class="project-one__img">
                                                    <img src="<?= base_url('assets-public/') ?>assets/images/project/project-1-1.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6">
                                ...
                                <div class="swiper-slide">
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="project-one__left">
                                                <div class="project-one__img">
                                                    <img src="<?= base_url('assets-public/') ?>assets/images/project/project-1-2.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6">
                                ...
                                <div class="swiper-slide">
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="project-one__left">
                                                <div class="project-one__img">
                                                    <img src="<?= base_url('assets-public/') ?>assets/images/project/project-1-3.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6">
                                ...
                                <div class="swiper-slide">
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="project-one__left">
                                                <div class="project-one__img">
                                                    <img src="<?= base_url('assets-public/') ?>assets/images/project/project-1-4.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="project-one__img-holder">
                                        <img src="<?= base_url('assets-public/') ?>assets/images/project/project-1-thumb-1.jpg" alt="">
                                    </div>
                                </div><!-- /.swiper-slide -->
                                <div class="swiper-slide">
                                    <div class="project-one__img-holder">
                                        <img src="<?= base_url('assets-public/') ?>assets/images/project/project-1-thumb-2.jpg" alt="">
                                    </div>
                                </div><!-- /.swiper-slide -->
                                <div class="swiper-slide">
                                    <div class="project-one__img-holder">
                                        <img src="<?= base_url('assets-public/') ?>assets/images/project/project-1-thumb-3.jpg" alt="">
                                    </div>
                                </div><!-- /.swiper-slide -->
                                <div class="swiper-slide">
                                    <div class="project-one__img-holder">
                                        <img src="<?= base_url('assets-public/') ?>assets/images/project/project-1-thumb-4.jpg" alt="">
                                    </div>
                                </div><!-- /.swiper-slide -->
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="team-one__single">
                                <div class="team-one__img-box">
                                    <div class="team-one__img">
                                        <img src="<?= base_url('assets-public/') ?>assets/images/team/team-1-1.jpg" alt="">
                        ...
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                            ...
                            <div class="team-one__single">
                                <div class="team-one__img-box">
                                    <div class="team-one__img">
                                        <img src="<?= base_url('assets-public/') ?>assets/images/team/team-1-2.jpg" alt="">
                                        <div class="team-one__social">
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-facebook"></i></a>
                                            <a href="#"><i class="fab fa-pinterest-p"></i></a>
                        ...
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="team-one__single">
                                <div class="team-one__img-box">
                                    <div class="team-one__img">
                                        <img src="<?= base_url('assets-public/') ?>assets/images/team/team-1-3.jpg" alt="">
                                        <div class="team-one__social">
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-facebook"></i></a>
                                            <a href="#"><i class="fab fa-pinterest-p"></i></a>
                        ...
                        <div class="col-xl-9">
                            ...
                            "1199": {
                                ...
                                "slidesPerView": 5
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="<?= base_url('assets-public/') ?>assets/images/brand/brand-1-1.png" alt="">
                                        </div><!-- /.swiper-slide -->
                                        <div class="swiper-slide">
                                            <img src="<?= base_url('assets-public/') ?>assets/images/brand/brand-1-2.png" alt="">
                                        </div><!-- /.swiper-slide -->
                                        <div class="swiper-slide">
                                            <img src="<?= base_url('assets-public/') ?>assets/images/brand/brand-1-3.png" alt="">
                                        </div><!-- /.swiper-slide -->
                                        <div class="swiper-slide">
                                            <img src="<?= base_url('assets-public/') ?>assets/images/brand/brand-1-4.png" alt="">
                                        </div><!-- /.swiper-slide -->
                                        <div class="swiper-slide">
                                            <img src="<?= base_url('assets-public/') ?>assets/images/brand/brand-1-5.png" alt="">
                                        </div><!-- /.swiper-slide -->
                                        <div class="swiper-slide">
                                            <img src="<?= base_url('assets-public/') ?>assets/images/brand/brand-1-1.png" alt="">
                                        </div><!-- /.swiper-slide -->
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget__column footer-widget__about">
                                <div class="footer-widget__logo">
                                    <a href="index.html"><img src="<?= base_url('assets-public/') ?>assets/images/resources/footer-logo.png" alt=""></a>
                                </div>
